...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "gradient-primary text-primary-foreground hover:opacity-90 shadow-purple",
        ...
        card: "bg-card text-card-foreground border-2 border-border hover:border-primary hover:bg-card-hover transition-smooth",
        poker: "bg-card text-card-foreground border-2 border-border hover:border-primary hover:shadow-purple transition-smooth hover:transform hover:scale-105",
        gradient: "gradient-secondary text-accent-foreground hover:opacity-90 shadow-magenta",
      },
      size: {
